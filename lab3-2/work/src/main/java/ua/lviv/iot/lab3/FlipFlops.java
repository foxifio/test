...
public class FlipFlops extends Shoe {
    private String soleMaterial;

    public FlipFlops(String name, Type type, Brand brand, Size size, String color, double price, String material, String soleMaterial) {
